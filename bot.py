...
Сегодня: $75+ млрд валуация, 50+ млн клиентов, >10k сотрудников (5k core + 7k support), 15 млн DAU. Моя доля — 29%. Цель: $9 млрд выручки и $3 млрд прибыли в 2026, 100 млн DAU, IPO не раньше 2028. Поддержка автоматизирована на 75% через LLM.
